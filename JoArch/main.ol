...
include "Jolie/OrchestratorInterface.iol"
include "console.iol"
include "file.iol"
...
Aggregates: FrontendPort, OrchestratorPort
}

embedded {
	Jolie: "Jolie/frontend.ol" in FrontendPort
	Jolie: "Jolie/orchestratorArch.ol" in OrchestratorPort
}
